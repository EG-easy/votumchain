...
const (
	EventTypeSubmitProposal   = govtypes.EventTypeSubmitProposal
	EventTypeProposalDeposit  = govtypes.EventTypeProposalDeposit
	EventTypeProposalVote     = govtypes.EventTypeProposalVote
	EventTypeInactiveProposal = govtypes.EventTypeInactiveProposal
	EventTypeActiveProposal   = govtypes.EventTypeActiveProposal

	AttributeKeyProposalResult     = govtypes.AttributeKeyProposalResult
	AttributeKeyOption             = govtypes.AttributeKeyOption
	AttributeKeyProposalID         = govtypes.AttributeKeyProposalID
	AttributeKeyVotingPeriodStart  = govtypes.AttributeKeyVotingPeriodStart
	AttributeValueCategory         = govtypes.AttributeValueCategory
	AttributeValueProposalDropped  = govtypes.AttributeValueProposalDropped
	AttributeValueProposalPassed   = govtypes.AttributeValueProposalPassed
	AttributeValueProposalRejected = govtypes.AttributeValueProposalRejected
	AttributeValueProposalFailed   = govtypes.AttributeValueProposalFailed
)
