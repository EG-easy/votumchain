...
var DefaultNodeHome = os.ExpandEnv("$HOME/.votumchaind")
...
func main() {
	...
	executor := cli.PrepareBaseCmd(rootCmd, "CT", DefaultNodeHome)
...
$ votumchaind add-genesis-account cosmos1tse7r2fadvlrrgau3pa0ss7cqh55wrv6y9alwh 1000STAKE,1000mycoin
`),
