...
import (
	...
	app "github.com/EG-easy/votumchain/app"
...
func exportAppStateAndTMValidators(
	...
	if height != -1 {
		votumApp := app.NewVotumApp(logger, db, traceStore, false, uint(1))
	...
	votumApp := app.NewVotumApp(logger, db, traceStore, true, uint(1))
