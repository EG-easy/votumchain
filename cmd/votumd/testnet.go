...
func testnetCmd(ctx *server.Context, cdc *codec.Codec,
	...
	cmd := &cobra.Command{
		Use:   "testnet",
		Short: "Initialize files for a votumd testnet",
...
Example:
	votumd testnet --v 4 --output-dir ./output --starting-ip-address 192.168.10.2
	`,
	...
	cmd.Flags().String(flagNodeDaemonHome, "votumd",
		"Home directory of the node's daemon configuration")
	cmd.Flags().String(flagNodeCLIHome, "votumcli",
...
func InitTestnet(cmd *cobra.Command, config *tmconfig.Config, cdc *codec.Codec,
	...
	votumConfig := srvconfig.DefaultConfig()
	votumConfig.MinGasPrices = minGasPrices
	...
	for i := 0; i < numValidators; i++ {
		...
		// TODO: Rename config file to server.toml as it's not particular to votum
		// (REF: https://github.com/cosmos/cosmos-sdk/issues/4125).
		votumConfigFilePath := filepath.Join(nodeDir, "config/votumd.toml")
		srvconfig.WriteConfigFile(votumConfigFilePath, votumConfig)
	}
